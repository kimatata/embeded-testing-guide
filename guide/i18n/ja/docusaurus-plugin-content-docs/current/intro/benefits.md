...
<img src={breakEven} alt="損益分岐点" width="700" /> [^1]
...
<img src={shiftLeft} alt="シフトレフト" width="700" /> [^2]
...
Doxygen(javadocのc言語版)で関数の説明をしても良いですが、実装と関数の説明が一致している保証はありません。関数の仕様変更や改修が重なれば説明を編集し忘れた、ということも出てくるでしょう。仕様に変更がありプロダクトコードに変更があったとき、もしテストコードの修正を忘れていてもテスト実行時にエラーが出るため気づくことができます。
